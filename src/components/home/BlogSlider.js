      ...
      <div className='container mx-auto mt-12'>
        <div className='box-swiper style-nav-top'>
          ...
          <div className='text-center mt-8'>
            <a
              href='/blog-grid'
              className='inline-flex items-center justify-center px-6 py-3 text-white bg-blue-600 rounded-lg shadow-md hover:bg-blue-700 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-300 ease-in-out'
            >
